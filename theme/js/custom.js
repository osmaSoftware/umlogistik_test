/*
   Template Name:  UMLogistik | The Multi-Purpose HTML5 Template
   Author: tripples
   Description:  UMLogistik | The Multi-Purpose HTML5 Template
   Version: 1.0
...
jQuery(function ($) {
   ...
   if ($('#map').length > 0) {
      ...
      var contactmap = {
		 ...
		 lat: 47.566051788553935,
         lng: 9.110026154326363
